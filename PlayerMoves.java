...
public class PlayerMoves {
    ...
    public static void host(){
        ...
        if(choice.toUpperCase().equals(playerX)){
        ...
        if(choice.toUpperCase().equals(playerO)) {
        ...
        while(true){
            ...
            while(checkMoves(row, col))
            {
                System.out.println("That slot is already taken, out of bounds, or an invalid move. Please try again.");
                printMethod(boardMoves);
                System.out.println("What is your row?");
                row = scan.nextInt();
                System.out.println("What is your column?");
    ...
    public static boolean checkPlayer(String player){
        if( (player.toUpperCase().equals("X")) || (player.toUpperCase().equals("O")) )      //If it does equal X or O then it would exit the while loop, if not it will stay true and stay in the while loop.
            return false;
